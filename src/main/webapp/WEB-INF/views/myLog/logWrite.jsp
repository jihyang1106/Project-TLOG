...
<form id='log_form' action='/myLog/logWriteOk' method='POST' enctype="multipart/form-data">
	<ul>
		<li>제목 : <input type='text' name='tTitle'/></li>
		<li><input type='date' name='startDate'/> - <input type='date' name='endDate'/></li>
		<li>위치정보(임시) : <input type='text' name='placeInfo'/></li>
		<li>
		          ...
		          success: function (data) {
		        	  ...
		        	  //console.log(list);
		        		...
		        		$(".search_user_li").on('click', function(){
		        			...
		        			$(this).parent().prev().val(userNick); //inputText
		        			$(this).parent().prev().prev().val(userNum); //inputHidden
